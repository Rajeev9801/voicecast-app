    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
        <motion.div 
          ...
          className="max-w-md w-full bg-zinc-900/50 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-red-500/20 shadow-2xl"
        >
    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white mb-2 uppercase tracking-tighter">New Password</h1>
          <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">Create a strong new password for your account</p>
          {email && <p className="text-zinc-500 mt-2 text-[10px] lowercase font-medium">{email}</p>}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-zinc-800/50 border border-zinc-700/50 rounded-2xl py-4 pl-12 pr-12 text-white placeholder:text-zinc-600 focus:outline-none focus:border-green-500/50 focus:ring-1 focus:ring-green-500/20 transition-all"
                placeholder="••••••••"
                required
                minLength={6}
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-500 group-focus-within:text-green-500 transition-colors" size={18} />
              <input
                type={showPassword ? "text" : "password"}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-green-500 hover:bg-green-400 disabled:bg-zinc-700 disabled:cursor-not-allowed text-black font-black py-4 rounded-2xl transition-all duration-300 shadow-xl shadow-green-500/20 uppercase tracking-[0.2em] text-xs mt-4 flex items-center justify-center gap-3"
          >
            {loading ? (
